...
public class NotificationDAOImpl implements NotificationDAO {
    ...
    @Override
    public NotificationDTO create(int recipientId, NotificationType type, String title, String message, Integer relId) throws SQLException {
    ...
    @Override
    public NotificationDTO create(int recipientId, NotificationType type, String title, String message, Integer relId, Connection conn) throws SQLException {
    ...
    public boolean markAllAsRead(int userId) throws SQLException {
        return db.update("UPDATE notifications SET is_read = TRUE WHERE recipient_id = ? AND is_read = FALSE", userId) > 0;
    }
